...
from models import (
    ...
    Payment,
    ChatMessage,
    association_table_order_product,
    association_table_product_review,
)
...
def seed_data():
    with app.app_context():
        ...
        # farmer1 = Farmer(
        #     farm_name="Green Farms", location="Somewhere", contact="1234567890"
        # )
        # farmer1.user = user2
        # farmer2 = Farmer(farm_name="skyfruits", location="Kenol", contact="1234567890")
        # farmer2.user = user4
        # farmer3 = Farmer(farm_name="joyview", location="thika", contact="1234567890")
        # farmer3.user = user5

        # db.session.add_all(
        #     [user1, user2, user3, user4, user5, farmer1, farmer2, farmer3]
        # )
        # db.session.commit()
        ...
        #     category="Fruit",
        #     image="https://i.pinimg.com/236x/41/6a/67/416a671f74edf7f2357e3cad537635b5.jpg",
        # )
        # product2 = Product(
        #     name="Eggs",
        #     price=15,
        #     description="Brown hen Eggs",
        #     quantity_available=100,
        #     category="Animal product",
        #     image="https://i.pinimg.com/564x/98/04/e2/9804e24442e977e5cb4da454b81d62af.jpg",
        # )
        # product3 = Product(
        #     name="Milk",
        #     price=65,
        #     description="fresh milk from the farmer",
        #     quantity_available=10,
        #     category="Animal product",
        #     image="https://i.pinimg.com/564x/ce/cc/84/cecc84661e9148366b24b6c130138efc.jpg",
        # )
        # product4 = Product(
        #     name="white meat",
        #     price=165,
        #     description="Thick chicken thigh ",
        #     quantity_available=150,
        #     category="Animal product",
        #     image="https://i.pinimg.com/564x/a7/ab/95/a7ab95e2c50ccae974c3b701e19bcec1.jpg",
        # )
        ...
        #     message_text="Hello, I would like to order some apples.",
        ...
        # db.session.execute(
        #     association_table_order_product.insert().values(
        ...
        # )
        # db.session.execute(
        #     association_table_product_review.insert().values(
